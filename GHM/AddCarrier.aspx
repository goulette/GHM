<%@ Page Title="GHM Intranet Administration - Add Carrier" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddCarrier.aspx.cs" Inherits="GHM.AddCarrier" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        <table style="text-align:center">
            <tr style="height: 50px">
                <td>
                    <asp:Label ID="AddCarrierLabel" runat="server" Text="GHM Intranet Administration - Add Carrier" CssClass="myHeaderLabel"></asp:Label>
                </td>
            </tr>
        </table>
         <table>
            ...
            <tr style="height: 60px">
                <td style="text-align:center" colspan="3">
                    <asp:Button ID="AddButton" runat="server" Text="Add" CssClass="myButton" onclick="AddButton_Click" />
