<%@ Page Title="Add Useful Site" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddUsefulSite.aspx.cs" Inherits="GHM.AddUsefulSite" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <body style:"width=100%;">
        <table align="center">
            <tr style="height: 50px">
                <td>
                    <asp:Label ID="AddUsefulSiteLabel" runat="server" Text="GHM Intranet Administration - Add Useful Site" CssClass="myHeaderLabel" ></asp:Label>
                </td>
            </tr>
         </table>
         <table align="center">
